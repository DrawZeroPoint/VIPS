...
def visualize_mixture(mixture_weights, mixture_means, l=None, clear_fig=True, markerPoses=[]):
    """
    :param mixture_weights: ndarray, [n_comp,] component weights
    :param mixture_means: ndarray, [n_comp, n_dim] mean value of each component
    ...
    """Dong
    The thetas generated by more weighted component get darker in the plot.
    All n_comp components have a corresponding link in the plot.
    """
    ...
    rect = patches.Rectangle((-0.25, -0.25), 0.5, 0.5, linewidth=1, edgecolor='k', fill=True, facecolor='blue',
                             zorder=1000)
    ax = plt.gca()
    ax.add_patch(rect)
